        ...
        messages: [
          {
            ...
            content:
              text +
              " keep the response concise and include any formatting as HTML with line breaks after bullet points (remove backticks and markdown)."
          }
        ]
      })
    })
      ...
      {hasRecognitionSupport ? (
        <>
          <div className="button-group">
            <button className="button start" onClick={startListening} disabled={isListening}>
              Start Listening
            </button>
          ...
          {isListening && <p className="listening">Your browser is currently listening...</p>}
